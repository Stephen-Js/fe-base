...
export type SignInCardCredentials = {
  username: string
  password: string
}
...
export function Component({ isLoading = false, errorMessage, onSubmit }: SignInCardProps) {
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={cn(
                          ...
                          focusedInput === 'username' && 'border-purple-500/50 bg-purple-500/5'
                        )}
